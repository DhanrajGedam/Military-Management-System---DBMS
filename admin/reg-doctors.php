...
$spl=$_POST['spl'];
$salary=$_POST['salary'];
$sql="INSERT INTO  tbldoctor(did,dname,spl,salary) VALUES(:did,:dname,:spl,:salary)";
$query = $dbh->prepare($sql);
$query->bindParam(':did',$did,PDO::PARAM_STR);
$query->bindParam(':dname',$dname,PDO::PARAM_STR);
$query->bindParam(':spl',$spl,PDO::PARAM_STR);
...
<input class="form-control" type="text" name="spl"  required="required" autocomplete="off"  />
</div>

  
 <div class="form-group">
 <label>Salary<span style="color:red;">*</span></label>
 <input class="form-control" type="text" name="salary" autocomplete="off"   required="required" />
 </div>
