...
$author=$_POST['author'];
$sql="update  tblemployees set ename=:author where id=:athrid";
$query = $dbh->prepare($sql);
$query->bindParam(':author',$author,PDO::PARAM_STR);
$query->bindParam(':athrid',$athrid,PDO::PARAM_STR);
$query->execute();
$_SESSION['updatemsg']="Employee info updated successfully";
...
<?php 
$athrid=intval($_GET['athrid']);
$sql = "SELECT * from  tblemployees where id=:athrid";
$query = $dbh -> prepare($sql);
$query->bindParam(':athrid',$athrid,PDO::PARAM_STR);
$query->execute();
